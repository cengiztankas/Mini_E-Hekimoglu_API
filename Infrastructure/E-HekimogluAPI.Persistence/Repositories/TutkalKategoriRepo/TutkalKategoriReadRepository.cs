...
{
    public class TutkalKategoriReadRepository : ReadRepository<TutkalKategori>, ITutkalKategoriReadRepository
    {
        public TutkalKategoriReadRepository(EHekimogluApiDbContext context) : base(context)
        {
        }
    }
}
